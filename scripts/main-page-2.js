...
document.addEventListener('DOMContentLoaded', () => {
    ...
    class CityList{
        ...
        handlerClickOverlay(element){
            if(!element.classList.contains(this.itemSelector) && element !== this.selectedCity) this.closeCityList();
        }

        displayCityList(){
            this.listCities.classList.remove('hide');
            this.listCities.classList.add('show');
            window.addEventListener('click', (e) => this.handlerClickOverlay(e.target),{once: true})
        }
    ...
    class Overlay{
        ...
        constructor(selectorName, elementForWhichOverlay){
        ...
        init(){
            ...
            console.log(this.elementForWhichOverlay, this.overlay)
        }
